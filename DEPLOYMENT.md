...
Deployed platform: Railway (successful).

- Railway config: 06-lab-complete/railway.toml
- Render config: 06-lab-complete/render.yaml

Current status: Production service is running on Railway.

---

## 2) Public URL

- Public URL: https://day12-production-1d49.up.railway.app
...
Executed tests on public domain:
...
- /ask without API key -> expected HTTP 401 (security behavior)
